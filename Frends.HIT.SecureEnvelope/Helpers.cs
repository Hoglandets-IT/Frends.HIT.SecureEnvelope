...
namespace Frends.HIT.SecureEnvelope {
    internal class Helpers {
        internal static X509Certificate2 GetX509Certificate(string certificate, string privatekey) {
            ...
            string decodedCert = System.Text.Encoding.UTF8.GetString(certData);
        ...
        // internal static XElement GetSoapRequest(X509Certificate2 certificate, DateTime timestamp, XElement bodyContent, string bodyReferenceId, string timestampReferenceId, string tokenReferenceId, Dictionary<string, XNamespace> namespaces)
        // {
        ...
        // internal static XElement GetUserInfoApplicationRequest(string customerId, string targetId, DateTime timestamp, Enums.Environment environment, string softwareId, Dictionary<string, XNamespace> namespaces)
        // {
        ...
        // internal static XElement GetUploadFileApplicationRequest(
        //     string customerId, DateTime timestamp, Enums.Environment environment, 
        //     string softwareId, Dictionary<string, XNamespace> namespaces, 
        //     string fileInput, string fileType, Encoding fileEncoding, string targetId
        // )
        // {
        ...
        // internal static XElement GetFileApplicationRequest(string customerId, DateTime timestamp, Enums.Environment environment, string softwareId, string fileReference, string fileType, string targetId, Enums.Status status, Dictionary<string, XNamespace> namespaces)
        // {
        //     return new XElement(namespaces["bxd"] + "ApplicationRequest",
        //         new XElement(namespaces["bxd"] + "CustomerId", customerId),
        ...
        // internal static XElement GetFileListApplicationRequest(string customerId, DateTime timestamp, Enums.Environment environment, string softwareId, string fileType, string targetId, DateTime? startDate, DateTime? endDate, Enums.Status status, Dictionary<string, XNamespace> namespaces)
        // {
        ...
        // internal static XElement GetRequestHeader(string senderId, int requestId, DateTime timestamp, string softwareId, Dictionary<string, XNamespace> namespaces)
        // {
        ...
        // internal static XElement GetSoapHeader(X509Certificate2 certificate, DateTime timestamp, string timestampReferenceId, string tokenReferenceId, Dictionary<string, XNamespace> namespaces)
        // {
        ...
        // internal static XmlDocument GetXmlDocument(string input)
        // {
        ...
        // internal static string SignApplicationRequestAndReturnAsBase64(XElement applicationRequest, X509Certificate2 certificate)
        // {
        ...
        // internal static XmlElement GetSignatureNode(XmlDocument document, X509Certificate2 certificate, IList<string> referenceIds, KeyInfo keyInfo)
        // {
        ...
        // internal static KeyInfo GetKeyInfoWithCert(X509Certificate2 certificate)
        // {
        ...
        // internal static KeyInfo GetKeyInfoWithSecurityToken(string reference, Dictionary<string, XNamespace> namespaces)
        // {
        ...
        // internal static List<XAttribute> ConvertNamespacesToAttributes(Dictionary<string, XNamespace> namespaces)
        // {
        //     return namespaces.Select(n => new XAttribute(XNamespace.Xmlns + n.Key, n.Value.NamespaceName)).ToList();
        // }

        // internal static XmlNamespaceManager GetNamespaceManagerFromNamespaces(XmlDocument document, Dictionary<string, XNamespace> namespaces)
        // {
        ...
        // internal static XElement FindElement(string xml, string elementName)
        // {
        ...
        // internal static void WriteNordeaFileInfo(this JTokenWriter writer, XmlNode node)
        // {
        ...
        // internal static XElement GetSimpleRequestHeader(XNamespace ns, string customerId, int requestId, DateTime timestamp)
        // {
        ...
        // internal static XElement GetCertificateApplicationRequest(string customerId, DateTime timestamp, Enums.Environment environment, string softwareId, Dictionary<string, XNamespace> namespaces, string transferKey, string pkcs10 = null)
        // {
        //     var properties = new List<XElement>
        //     {
        //         new XElement(namespaces["bxd"] + "CustomerId", customerId),
